...
class TelemetryCollector:
    ...
    _event_status_map = {
        ...
        "task_step_created": "analyzing",
        "task_step_transitioned": "analyzing",
    ...
    def collect(self, db: Session, payload: dict) -> AuditEvent:
        ...
        event = AuditEvent(
            ...
            alignment_score=normalized["alignment_score"],
            alignment_decision=normalized["alignment_decision"],
            alignment_reason=normalized["alignment_reason"],
            intended_effect=normalized["intended_effect"],
            actual_effect=normalized["actual_effect"],
